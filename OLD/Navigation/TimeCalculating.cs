    ...
    public class TimeCalculating
    {
        ...
        static Trajectory CurrentTime(CirclePart Circle1, CirclePart Circle2)
        {
            ...
            else
            {
                ...
                T.Ax = Math.Cos(AngleDiff) * (Circle2.VX * Circle2.VX + Circle2.VY * Circle2.VY - 
                    (Circle1.VX * Circle1.VX + Circle1.VY * Circle1.VY)) / (2 * LengthC);
                T.Ay = Math.Sin(AngleDiff) * (Circle2.VX * Circle2.VX + Circle2.VY * Circle2.VY - 
                    (Circle1.VX * Circle1.VX + Circle1.VY * Circle1.VY)) / (2 * LengthC);
                if (T.Ax != 0)
                {
                ...
                T.VX = Vx;
                T.VY = Vy;
                T.X = Circle1.Rad * Math.Cos(Circle1.Omg * T1 + Circle1.FI) + Circle1.Center.x;
                T.Y = Circle1.Rad * Math.Sin(Circle1.Omg * T1 + Circle1.FI) + Circle1.Center.y;
                return T;
        }   
    }
}