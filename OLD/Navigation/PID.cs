...
namespace Navigation
{
    public class PID
    {
        static double FindTakeOff(TraectoryEnsemble e, MathLib.Vector coor, MathLib.Vector Speed,ref bool b)
        {
        ...
        static double FindCirc1(TraectoryEnsemble e, MathLib.Vector coor, MathLib.Vector Speed, ref bool b)
        {
            double x = coor.X;
            double y = coor.Y;
            double z = coor.Z;
        ...
        static double FindLine(TraectoryEnsemble e, MathLib.Vector coor, MathLib.Vector Speed, ref bool b)
        {
            double x = coor.X;
            double y = coor.Y;
            double z = coor.Z;
        ...
        static double FindCirc2(TraectoryEnsemble e, MathLib.Vector coor, MathLib.Vector Speed, ref bool b)
        {
            double x = coor.X;
            double y = coor.Y;
            double z = coor.Z;
        ...
        public static MathLib.Vector Find(TraectoryEnsemble e, MathLib.Vector coor, MathLib.Vector Speed)
        {
            bool b1 = true;
            bool b2 = true; 
            bool b3 = true; 
